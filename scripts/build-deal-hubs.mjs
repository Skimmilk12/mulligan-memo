...
${hub.intro}
    ...
    <div class="dd-how">
      <p>Biggest cuts first. Every "was" price shown is the retailer's own compare-at figure. Prices move — check the live listing before you buy, and see <a class="inline" href="/deals.html">the front page</a> for the picks worth your attention across every department.</p>
    </div>
